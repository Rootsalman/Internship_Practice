/*
Create a class called "Rectangle" with attributes "length" and "width". Create an ArrayList of Rectangle objects and add 4 RectangleArrayList to it. Print the length and width of each rectangle. Calculate and print the area of each rectangle.
*/
import java.util.*;
class Rectangle {
    double length, width;
